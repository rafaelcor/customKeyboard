...
class CustomKey:
    ...
    def setSave(self, newContent):
        self.save = newContent
    ...
    def add_file_menu_actions(self, action_group):
        ...
        action_fileopen.connect("activate", openFromKeyboard)
        ...
        action_filesaveas.connect("activate", saveAllToZip, self.save)
    ...
    def move_key(self, widget, event, key):
        """This function has the mission of move keys"""
        if not self.editing:
    ...
    def change_name(self, widget, event, key, button):
        """This function is executed after onButtonDoubleClick and lets
         you change button text"""
        print event.keyval
    ...
    def onButtonDoubleClick(self, widget, event, key):
        """This function is executed when you press a key twice"""
        print widget
        self.editing = True
        print ("2 clicked")
    ...
    def new_button(self, widget, event):
        """This function has the is the responsable to create new keys"""
        print self.save
    ...
    def onButtonRelease(self, widget, event, key):
        """This function is executed when a button is released"""
    ...
    def invokeImageDialog(self, widget, event):
        """This dialogs is for select an image for put as a background on a key
        """
    ...
    def editButton(self, widget, event):
        """The window that lets you customize your key"""
